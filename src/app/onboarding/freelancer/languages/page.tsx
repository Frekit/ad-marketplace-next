                ...
                <div className="max-w-6xl w-full grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-4">
                            <div className="space-y-4">
                                ...
                                <Select defaultValue="native">
                                    <SelectTrigger className="h-14 pl-6 text-lg rounded-full border-2 w-full">
                                        <SelectValue placeholder="Nivel" />
                                    </SelectTrigger>
                                    <SelectContent>
                                        <SelectItem value="native">Bilingüe o nativo</SelectItem>
                            ...
                            <button className="flex items-center gap-2 text-[#0F4C5C] font-bold hover:underline pl-2">
                                <Plus className="h-5 w-5" /> Añadir otro idioma
                            </button>
                        </div>
                        ...
                        <div className="flex justify-between pt-8">
                            ...
                            <Button className="h-12 px-8 rounded-full bg-[#FF5C5C] hover:bg-[#FF5C5C]/90 text-white" onClick={() => router.push('/onboarding/freelancer/years-experience')}>
                                Siguiente
                            </Button>
                        </div>
                    </div>
